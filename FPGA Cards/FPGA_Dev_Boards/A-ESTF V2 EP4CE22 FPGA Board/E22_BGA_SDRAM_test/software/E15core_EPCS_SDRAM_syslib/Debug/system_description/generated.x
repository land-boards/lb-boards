 ...
 *
 * Generated: 2018-01-26 18:37:00.843
 *
 */
...
MEMORY
{
    reset : ORIGIN = 0x04801800, LENGTH = 32
    cfi_flash_0 : ORIGIN = 0x04400000, LENGTH = 4194304
    epcs_flash_controller_0 : ORIGIN = 0x04801820, LENGTH = 2016
    sdram_0_UNUSED : ORIGIN = 0x02000000, LENGTH = 32
    sdram_0 : ORIGIN = 0x02000020, LENGTH = 33554400
}

    /* Define symbols for each memory base-address */
 __alt_mem_cfi_flash_0 = 0x04400000 ;
 __alt_mem_epcs_flash_controller_0 = 0x04801800 ;
 __alt_mem_sdram_0 = 0x02000000 ;
...
PROVIDE( __alt_heap_limit    = 0x04000000 );
