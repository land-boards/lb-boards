...
U 1 1 61CDB7A0
P 8475 1625
F 0 "D5" V 8521 1545 50  0000 R CNN
F 1 "1N4148" V 8430 1545 50  0000 R CNN
F 2 "Diode_THT:D_DO-35_SOD27_P7.62mm_Horizontal" H 8475 1450 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/1N4148_1N4448.pdf" H 8475 1625 50  0001 C CNN
	1    8475 1625
	0    -1   -1   0   
$EndComp
...
U 1 1 61DBB1EA
P 9025 2350
F 0 "#PWR014" H 9025 2100 50  0001 C CNN
F 1 "GND2" H 9030 2177 50  0000 C CNN
...
U 1 1 61DE2DCA
P 700 3775
F 0 "J1" H 725 3450 50  0000 R CNN
F 1 "INPUT" H 800 3525 50  0000 R CNN
F 2 "benjiaomodular:AudioJack_3.5mm" H 700 3775 50  0001 C CNN
F 3 "~" H 700 3775 50  0001 C CNN
	1    700  3775
	1    0    0    1   
$EndComp
Text GLabel 1050 3775 2    50   Output ~ 0
A1
...
U 1 1 61F0882F
P 975 4000
F 0 "#PWR01" H 975 3750 50  0001 C CNN
F 1 "GND1" H 980 3827 50  0000 C CNN
F 2 "" H 975 4000 50  0001 C CNN
F 3 "" H 975 4000 50  0001 C CNN
	1    975  4000
	1    0    0    -1  
$EndComp
Text GLabel 6650 1925 2    50   Output ~ 0
A3
Wire Wire Line
	6200 1925 6250 1925
Connection ~ 6250 1925
Text GLabel 6950 1925 0    50   Output ~ 0
B3
Wire Wire Line
	5900 1925 5875 1925
Text GLabel 6200 1925 0    50   Output ~ 0
A4
Wire Wire Line
	7325 1925 7425 1925
$Comp
...
F 3 "https://assets.nexperia.com/documents/data-sheet/1N4148_1N4448.pdf" H 7175 1925 50  0001 C CNN
	...
	-1   0    0    1   
$EndComp
Text GLabel 5900 1925 2    50   Output ~ 0
B4
Wire Wire Line
	6650 1925 6600 1925
Wire Wire Line
...
U 1 1 61CD07DC
P 8575 2075
F 0 "POT_DECAY1" H 9175 2125 50  0000 R CNN
F 1 "1M" H 8505 2030 50  0000 R CNN
F 2 "benjiaomodular:Potentiometer_RV09" H 8575 2075 50  0001 C CNN
F 3 "~" H 8575 2075 50  0001 C CNN
	1    8575 2075
	-1   0    0    -1  
$EndComp
Text GLabel 8575 1925 1    50   Output ~ 0
A5
Text GLabel 8475 1800 3    50   Output ~ 0
B5
Wire Wire Line
	8475 1775 8475 1800
Text GLabel 8575 2325 3    50   Output ~ 0
A6
Text GLabel 8675 2450 1    50   Output ~ 0
B6
Wire Wire Line
	8675 2450 8675 2475
Wire Wire Line
...
Text GLabel 7600 2525 1    50   Output ~ 0
A9
Text GLabel 7600 2225 3    50   Output ~ 0
B9
Wire Wire Line
	7600 2150 7600 2225
Wire Wire Line
...
U 1 1 61F01A7D
P 10775 1750
F 0 "#PWR019" H 10775 1500 50  0001 C CNN
F 1 "GND1" H 10780 1577 50  0000 C CNN
...
$EndComp
Wire Wire Line
	10675 1625 10800 1625
Connection ~ 10675 1625
Wire Wire Line
	10625 1625 10675 1625
Text GLabel 10625 1625 0    50   Output ~ 0
A2
Wire Wire Line
	10775 1725 10775 1750
Wire Wire Line
	10775 1725 10800 1725
$Comp
L Connector:AudioJack2_SwitchT J2
U 1 1 61DE60D7
P 11000 1625
F 0 "J2" H 11050 1300 50  0000 R CNN
F 1 "OUTPUT" H 11150 1375 50  0000 R CNN
F 2 "benjiaomodular:AudioJack_3.5mm" H 11000 1625 50  0001 C CNN
F 3 "~" H 11000 1625 50  0001 C CNN
	1    11000 1625
	-1   0    0    1   
$EndComp
Wire Wire Line
	10675 2325 10675 2300
Wire Wire Line
	10675 2650 10675 2625
$Comp
L Device:R R12
U 1 1 61DA0801
P 10675 2475
F 0 "R12" V 10575 2475 50  0000 C CNN
F 1 "10k" V 10675 2475 50  0000 C CNN
F 2 "Resistor_THT:R_Axial_DIN0207_L6.3mm_D2.5mm_P7.62mm_Horizontal" V 10605 2475 50  0001 C CNN
...
U 1 1 61D9041E
P 10675 2150
F 0 "D7" V 10714 2032 50  0000 R CNN
F 1 "OUTPUT_LED" V 10650 2075 50  0000 R CNN
F 2 "LED_THT:LED_D3.0mm" H 10675 2150 50  0001 C CNN
F 3 "~" H 10675 2150 50  0001 C CNN
	1    10675 2150
	0    -1   -1   0   
$EndComp
Wire Wire Line
	10675 2000 10675 1625
NoConn ~ 10800 1525
$Comp
L power:GND1 #PWR018
U 1 1 61F03D14
P 10675 2650
F 0 "#PWR018" H 10675 2400 50  0001 C CNN
F 1 "GND1" H 10680 2477 50  0000 C CNN
...
A8
Text GLabel 7975 2850 0    50   Output ~ 0
B8
Wire Wire Line
	8025 2850 7975 2850
Wire Wire Line
	7800 2750 7750 2750
Text GLabel 6225 1425 0    50   Output ~ 0
A11
Text GLabel 5825 1425 2    50   Output ~ 0
B11
Wire Wire Line
	6650 1425 6625 1425
Wire Wire Line
...
Wire Wire Line
	8100 5425 8050 5425
Text GLabel 6650 1425 2    50   Output ~ 0
A10
Text GLabel 7050 1425 0    50   Output ~ 0
B10
Wire Wire Line
	7050 1425 7075 1425
Wire Wire Line
...
U 1 1 61F583BB
P 9025 2100
F 0 "C8" H 8875 2175 50  0000 C CNN
F 1 "470nF" H 8875 2250 50  0000 C CNN
F 2 "benjiaomodular:Capacitor_Rect_L7.2mm_W2.5mm_P5.00mm" H 9063 1950 50  0001 C CNN
F 3 "~" H 9025 2100 50  0001 C CNN
	1    9025 2100
	-1   0    0    1   
$EndComp
Text GLabel 9450 2450 1    50   Output ~ 0
A12
Text GLabel 9450 2025 3    50   Output ~ 0
B12
...
U 1 1 61F875F4
P 9450 2800
F 0 "SW1" V 9404 2930 50  0000 L CNN
F 1 "SW_DIP_x01" V 9495 2930 50  0000 L CNN
F 2 "benjiaomodular:ToggleSwitch_MTS-101_SPST" H 9450 2800 50  0001 C CNN
...
U 1 1 61FADE76
P 9450 3525
F 0 "#PWR021" H 9450 3275 50  0001 C CNN
F 1 "GND1" H 9455 3352 50  0000 C CNN
...
U 1 1 61D26594
P 9450 3300
F 0 "C3" H 9550 3225 50  0000 L CNN
F 1 "4.7uF" H 9500 3150 50  0000 L CNN
F 2 "Capacitor_THT:CP_Radial_D5.0mm_P2.50mm" H 9488 3150 50  0001 C CNN
