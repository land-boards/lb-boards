...
export LoadConfig_photoframe8pin
export _LoadConfig_photoframe8pin
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfigTBL_photoframe8pin_Ordered
	lcall	LoadConfig_photoframe8pin
...
;---------------------------------------------------------------------------
; Load Configuration photoframe8pin
;
;    Load configuration registers for photoframe8pin.
...
;               CUR_PP
;
_LoadConfig_photoframe8pin:
 LoadConfig_photoframe8pin:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_photoframe8pin_Bank0
    mov     X, <LoadConfigTBL_photoframe8pin_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_photoframe8pin_Bank1
    mov     X, <LoadConfigTBL_photoframe8pin_Bank1
