...
(function() {
  $(document).ready(function() {
    ...
    cart = $('#cart');
    init = function() {
      return cart.find('input').change(function() {
        cart.find('#checkout').addClass('disabled');
        return cart.find('form').submit();
      });
    };
    cart.on('ajax:send', function(xhr) {
      return cart.find('input:visible').attr('disabled', 'disabled');
    });
    cart.on('ajax:complete', function(e, xhr, status) {
